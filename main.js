...
var _user$project$About$view = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('A little about me'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('I\'m a huge fan of Elm, and for the most part I still love JavaScript too; even if it isn\'t as good, or as much fun. ;) '),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Blogs$view = A2(
	_elm_lang$html$Html$section,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Things that I\'ve written at some point'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://dev.to/dnimmo/i-was-wrong-to-dismiss-elm-and-i-think-you-probably-aretoo'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('I was wrong to dismiss Elm, and I think you probably are too (Dev.to)'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href('https://medium.com/@dnimmo/responsive-is-a-responsibility-not-a-choice-8ae5455bf7c3#.qvj9j1644'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('\'Responsive\' is a responsibility, not a choice (Medium)'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('https://medium.com/@dnimmo/if-youre-going-to-learn-javascript-learn-javascript-5fb3326fe8f5#.e3y2z7gxg'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('If you\'re going to learn JavaScript, learn JavaScript (Medium)'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
...
var _user$project$Footer$view = A2(
	_elm_lang$html$Html$footer,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('David Nimmo : dnimmo at gmail.com'),
		_1: {ctor: '[]'}
	});
...
var _user$project$Header$view = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('nimmo : caffeine -> requirements -> code'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});

var _user$project$Style$Test = {ctor: 'Test'};
var _user$project$Style$css = _rtfeldman$elm_css$Css$stylesheet(
	{
		ctor: '::',
		_0: A2(
			F2(
			...
			_user$project$Style$Test,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$backgroundColor(
					A4(_rtfeldman$elm_css$Css$rgba, 255, 0, 0, 0.7)),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});

var _user$project$SideProjects$view = A2(
	_elm_lang$html$Html$section,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Side Projects'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('dnimmo.co.uk'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('The site you\'re looking at now. Yes, it\'s basic, and yes it\'s unimpressive; don\'t worry, I know. But I wanted to knock together a quick website in Elm before carrying on with something more complex'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('https://github.com/dnimmo/dnimmo.co.uk'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Codebase (Github)'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Project Arklay'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('A simple text-adventure game that I built at a point when I was dissatisfied with my job, and needed something to help motivate me.'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
											...
											{ctor: '[]'},
											{
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$href('https://github.com/dnimmo/project-arklay'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('API (Github)'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$href(' https://github.com/dnimmo/project-arklay-client'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Client (Github)'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
												...
												{ctor: '[]'},
												{
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$href('http://project-arklay.com'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('project-arklay.com'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
...
var _user$project$Profiles$view = A2(
	_elm_lang$html$Html$section,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Online profiles'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('If you fancy stalking me for some reason, you can do so in any of these places.'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('For people who would like to contact me about job opportunities: '),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$a,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('https://uk.linkedin.com/in/david-nimmo-89568666'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('For people who would like to look over the assortment of bits of code I add to whenever the mood strikes: '),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$a,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href('https://github.com/dnimmo'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('For people who would like to see me complain at companies: '),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$a,
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$href('https://twitter.com/K_Fistman'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('For people who have heard of Google+: '),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$a,
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$href('https://plus.google.com/+DavidNimmo'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
...
var _user$project$Main$footer = _user$project$Footer$view;
var _user$project$Main$profiles = _user$project$Profiles$view;
var _user$project$Main$projects = _user$project$SideProjects$view;
var _user$project$Main$blogs = _user$project$Blogs$view;
var _user$project$Main$about = _user$project$About$view;
var _user$project$Main$header = _user$project$Header$view;
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$Main$profiles,
							_1: {
								ctor: '::',
